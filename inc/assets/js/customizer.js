...
( function( $ ) {
	 ...
	 * .page
	 */
	wp.customize( 'aeroblog[container-width-page]', function( value ) {
	 ...
	 * .search
	 */
	wp.customize( 'aeroblog[container-width-archive]', function( value ) {
		value.bind( function( newval ) {
	 ...
	 * .single
	 */
	wp.customize( 'aeroblog[container-width-single]', function( value ) {
		value.bind( function( newval ) {
